...
#define S2226_ARM_FW_VERSION (0x00000230)//(big endian always)
...
#define INPUTSAVE_LOCATION      (SERIAL_NUM_LOCATION + 1024)
#define INPUTSAVE_PREFIX_TOKEN  0x77
#define INPUTSAVE_OFFSET        15
